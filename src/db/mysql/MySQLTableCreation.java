	...
	public static void main(String[] args) {
		try {
			...
			// This is java.sql.Connection. Not com.mysql.jdbc.Connection.
						...
						sql = "CREATE TABLE courses " + "(user_id VARCHAR(255) NOT NULL, " + " name VARCHAR(255) NOT NULL, "
								+ " semster VARCHAR(255)," + "grade TINYINT(100), " + " PRIMARY KEY ( user_id ))";
						stmt.executeUpdate(sql);	
						...
						//second try
						sql = "INSERT INTO courses " + "VALUES (\"1111\", \"John Smith\", \"Fall 2016\", 100)";
